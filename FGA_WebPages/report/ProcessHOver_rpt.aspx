<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessHOver_rpt.aspx.cs" Inherits="FGA_PLATFORM.report.ProcessHOver_rpt" %>
...
<body>
    ...
    //查询界面
        ...
        $.ajax({
            type: "Post",
            url: "ProcessHOver_rpt.aspx/SearchData",
