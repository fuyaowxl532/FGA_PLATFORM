...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
            var parent = $(this).parent().parent(); //page-sidebar-menu
            parent.children('li.open').children('a').children('.arrow').removeClass('open');
            parent.children('li.open').children('.sub-menu').slideUp(200);
            parent.children('li.open').children('.sub-menu').children('li.open').removeClass('open');
    ...
    var handleGoTop = function () {
        ...
        jQuery('.footer').on('click', '.go-top', function (e) {
            //scroll frame body to top
            $(document.contentFrame.document.body).animate({ scrollTop: '0' });
            //App.scrollTo();
            e.preventDefault();
        });
    }
    ...
    var handleContentHeight = function () {
        var htWin = $(window).outerHeight();
        var htTop = $('.navbar-inner').outerHeight();
        var htFoot = $('.footer').outerHeight();
        var max = htWin - htTop - htFoot;
        //alert(htWin+' '+htTop+'-'+htFoot);
        var maxHt = max + 'px';

        var pc = $('.page-content');
        pc.css('min-height', maxHt);
        pc.css('height', maxHt);

        var pcf = pc.find('.container-fluid');
        pcf.css('min-height', maxHt);
        pcf.css('height', maxHt);
        
        $("#contentFrame").height(max + 'px');
