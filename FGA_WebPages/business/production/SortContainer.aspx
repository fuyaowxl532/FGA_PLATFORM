<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SortContainer.aspx.cs" Inherits="FGA_PLATFORM.business.production.SortContainer" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Sort Container</title>
    ...
    <div class="panel-body filter-wrapper col-lg-6" style="height:350px;width: 400px; margin-left:50px;"> 
            ...
            <div >
                <div style="margin-top:15px;margin-left:30px">
					...
					<input type="text" id = "barcode" placeholder="input" style="color: black; height:30px;width:200px; " />
                </div>	
    ...
    <div class="panel-body filter-wrapper col-lg-12" style="height:350px;width: 400px; margin-left:50px;"> 
            ...
            <div>
                    <p style="font-size:25px;margin-left:30px; margin-top:15px"><b>New Operation Code:<label style="color:black;margin-left:5px">1300</label></b></p>
							...
							<select id ="sloc" style="color: black; height:30px;width:150px; " >
                             <option>F410</option>
						     <option>F430</option>
						     <option>F420</option>
							</select>
                             ...
                             <div style="margin-top:10px;margin-left:30px">
					            ...
					            <input type="text" id = "Text2" placeholder="input" style="color: black; height:30px;width:150px; " />
                             </div>   
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#barcode').keydown(function (e) {
                ...
                if (key == 13) {
                    $.ajax({
                        type: "Post",
                        url: "SortContainer.aspx/GetDAContainer",
        ...
        function submit() {
            ...
            var print;
                ...
                $.ajax({
                    type: "Post",
                    url: "SortContainer.aspx/CompareQty",
