<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessUserCtrl.aspx.cs" Inherits="FGA_PLATFORM.business.production.ProcessUserCtrl" %>
  ...
  <form id="form1" runat="server">
    ...
    <script type="text/javascript" >
        ...
        function inRow() {
            ...
            $("#editable tr").last().find("td").eq(3).html('<select id ="org" style="width:100px;">' +
                        '<option value="F1">F1</option>' +
                        '<option value="F2">F2</option>' +
                        '<option value="F3">F3</option>' +
                        '<option value="F4">F4</option>' +
                        '</select>');
            $("#editable tr").last().find("td").eq(4).html('<input type="text"  style="border:none;width:100%;height:100%"/>');
            $("#editable tr").last().find("td").eq(5).html('<select id ="sid" style="width:100px;">' +
                        '<option value="IM1301">IM1301</option>' +
                        '<option value="IM1302">IM1302</option>' +
                        '<option value="IM1301_C">IM1301_C</option>' +
                        '<option value="IM1302_C">IM1302_C</option>' +
                        '</select>');
